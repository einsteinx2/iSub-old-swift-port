...
extension CustomUITableViewCell : CellOverlayDelegate {
    ...
    public func cellOverlayDownloadButtonPressed(overlay: CellOverlay) {
        self.hideOverlay()
        self.delegate?.tableCellDownloadButtonPressed(self)
    }
    
    public func cellOverlayQueueButtonPressed(overlay: CellOverlay) {
        self.hideOverlay()
        self.delegate?.tableCellQueueButtonPressed(self)
    }
    
    public func cellOverlayBlockerButtonPressed(overlay: CellOverlay) {
        self.hideOverlay()
        self.delegate?.tableCellBlockerButtonPressed?(self)
    }
    
    public func cellOverlayDeleteButtonPressed(overlay: CellOverlay) {
        self.hideOverlay()
        self.delegate?.tableCellDeleteButtonPressed?(self)
    }
}