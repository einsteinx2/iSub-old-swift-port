...
- (void)preSilenseLengthInternal:(Song *)aSong
{
...
- (QWORD)preSilenceLengthForSong:(Song *)aSong
{
	...
	[self performSelectorOnMainThread:@selector(preSilenseLengthInternal:) withObject:aSong waitUntilDone:YES];
